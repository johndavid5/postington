...
export const strContainsIgnoreCase = function(strFinder, strFindIn) {
    let strFinderLower = strFinder.toLocaleLowerCase();
    let strFindInLower = strFindIn.toLocaleLowerCase();
    return (strFindInLower.indexOf(strFinderLower) !== -1);
}

export const strBeginsWithIgnoreCase = function(strFinder, strFindIn) {
    let strFinderLower = strFinder.toLocaleLowerCase();
    let strFindInLower = strFindIn.toLocaleLowerCase();
    return (strFindInLower.indexOf(strFinderLower) === 0);
}
...
let utils = { customStringify, errorStringify, objectToQueryString, queryStringToObject, strEqualsIgnoreCase, compareStrings, strContainsIgnoreCase, strBeginsWithIgnoreCase, stringToBool }
export { utils }
